...
HD_PWD='C:/Users/PC/Desktop/FinalProjectECE532/handgesture/handgesture.runs/handgesture_mb_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handgesture_mb_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handgesture_mb_microblaze_0_axi_intc_0.tcl
