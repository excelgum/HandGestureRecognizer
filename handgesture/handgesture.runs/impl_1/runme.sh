...
HD_PWD='C:/Users/PC/Desktop/FinalProjectECE532/handgesture/handgesture.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log handgesture_mb_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source handgesture_mb_wrapper.tcl -notrace
