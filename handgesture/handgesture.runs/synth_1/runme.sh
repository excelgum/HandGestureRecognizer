...
HD_PWD='C:/Users/PC/Desktop/FinalProjectECE532/handgesture/handgesture.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log handgesture_mb_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source handgesture_mb_wrapper.tcl
